export default [
  ...
  {
    id: "aquelarre",
    title: "Aquelarre: Generador de Personajes",
    tags: ["JavaScript", "HTML", "CSS"],
    links: [
      { name: "github", url: "https://github.com/rucev/AquelarreCharacterGenerator" },
      { name: "web", url: "https://aquelarrepersonaje.surge.sh/" },
    ],
    about: `<p>Un <b>generador de personatges</b> basat en el clàssic joc de rol espanyol <b>Aquelarre</b>, ambientat en una <em>Ibèria medieval mítica</em>. Crea personatges aleatoris amb el <b>sistema tradicional de daus</b>.</p>`
  },
  {
    id: "pokemontypes",
    title: "Joc de Tipus Pokémon",
  ...
  },
  {
    ...
    about: `<p><b>Auca</b> va ser creat per a la <b>hackathon Technica 2022</b> i utilitza <b>imatges generades amb IA</b> per explicar <em>històries visuals</em>. Inspirat en les <b>aucas catalanes</b>, fa servir text narratiu en lloc de bafarades.</p>
