export default [
  ...
  },
  {
    ...
    years: "Mayo 2023 - Diciembre 2023",
    role: 'Junior Frontend Developer',
    stack: ['react', 'vue', 'next', 'ts', 'js', 'git', 'html', 'css', 'three', 'bootstrap', 'mocha'],
    company: 'Beemeral',
    contentInner: "<li>Construir prototipos con <b>React y Next.js</b>, aprovechando SSR y CSR para mejorar el rendimiento y el SEO.</li><li>Desarrollar <b>funcionalidades interactivas</b> como Drag and Drop.</li><li>Crear componentes visuales usando <b>Canvas</b>, <b>Three.js</b> y <b>animaciones CSS</b>.</li><li>Evaluar el rendimiento del prototipo y la experiencia de usuario, proporcionando <b>documentación detallada</b> de los hallazgos.</li>"
  },
]